    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        ...
        >
          ...
          {/* Step 3: Address Information (Signup only) */}
          {step === 3 && mode === 'signup' && (
            <div className="space-y-4">
              <div className="text-center mb-4">
                <h3 className="text-lg font-semibold">معلومات التوصيل</h3>
                <p className="text-gray-600 dark:text-gray-400">أدخل عنوان التوصيل</p>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className={`w-full p-3 border rounded-lg ${errors.governorate ? 'border-red-500' : 'border-gray-300'}`}
                >
