...
import type { Product, InsertProduct, Driver, InsertDriver } from '@shared/schema';
...
function DriversManagement() {
  ...
  const addDriverMutation = useMutation({
    mutationFn: (driverData: InsertDriver) => 
      fetch('/api/drivers', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleAddDriver = () => {
    if (!addDriverForm.fullName || !addDriverForm.phone || !addDriverForm.email) {
      toast({
        title: "معلومات ناقصة",
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 mb-2">إدارة السواق</h1>
          <p className="text-gray-600">إدارة حسابات السواق والمركبات</p>
        </div>
        <Button
          ...
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-600">إجمالي السواق</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-600">السواق النشطين</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-600">السواق غير النشطين</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="space-y-4">
        {drivers.length === 0 ? (
          <div className="bg-white rounded-lg p-12 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">لا توجد سواق</h3>
            <p className="text-gray-600">لم يتم إضافة أي سائق حتى الآن.</p>
          </div>
        ) : (
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
                      ...
                      {driver.plateNumber && (
                        <div className="flex items-center gap-2">
                          <span className="font-medium">رقم اللوحة: {driver.plateNumber}</span>
                        </div>
                      )}
                    </div>
                  </div>
                ...
                <div className="flex flex-col items-end gap-2">
                  <div className="flex gap-2">
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => toggleDriverStatus.mutate({ 
                        driverId: driver.id, 
                    ...
                    >
                      {driver.isActive ? 'إلغاء التفعيل' : 'تفعيل'}
                    </Button>
                    <Button
                      variant="outline"
                      size="sm"
                  ...
                  <div className="text-right">
                    <div className="text-xs text-gray-500 mb-1">تاريخ الإضافة</div>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                id="fullName"
                value={addDriverForm.fullName}
                onChange={(e) => setAddDriverForm(prev => ({ ...prev, fullName: e.target.value }))}
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => setAddDriverForm(prev => ({ ...prev, phone: e.target.value }))}
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => setAddDriverForm(prev => ({ ...prev, licenseNumber: e.target.value }))}
            ...
            <div>
              ...
              <Select 
                ...
                onValueChange={(value) => setAddDriverForm(prev => ({ ...prev, vehicleType: value }))}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div>
              ...
              <Input
                id="vehicleModel"
                value={addDriverForm.vehicleModel}
                onChange={(e) => setAddDriverForm(prev => ({ ...prev, vehicleModel: e.target.value }))}
            ...
            <div>
              ...
              <Input
                id="plateNumber"
                value={addDriverForm.plateNumber}
                onChange={(e) => setAddDriverForm(prev => ({ ...prev, plateNumber: e.target.value }))}
                placeholder="123 أ ب ج"
              />
            </div>
