  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="w-full px-2 py-1.5 text-xs border border-gray-300 rounded-md focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all bg-white flex items-center justify-between"
          ...
          >
            {options.map((option) => (
              <button
                ...
                className="w-full px-2 py-1 text-left text-xs hover:bg-green-50 transition-colors border-b border-gray-100 last:border-b-0"
                style={{ fontFamily: 'Cairo, system-ui, sans-serif' }}
              >
                {option}
              </button>
